...
const ReservationUpdateSuccess = () => {
  ...
  return (
    <section data-aos="fade-up" className="updateSuccess">
      <div className="container padding">
        <div className="success-msg-wrapper">
          <p className="sucess-txt">Your Reservation change is Successfull.</p>
...
export default ReservationUpdateSuccess;
